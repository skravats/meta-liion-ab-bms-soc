...
SRC_URI_append_liion-ab-bms-soc += " \
				file://socfpga_cyclone5_liion_ab_bms_soc \
...
do_compile_prepend () {                                                            
        ...
        cp ${TOPDIR}/../meta-liion-ad-bms-soc/recipes-kernel/linux/config/socfpga_cyclone5_liion_ab_bms_soc.dts ${S}/arch/${ARCH}/boot/dts                          
}  
