SUMMARY = "Liion AB/BMS Units to initialize USB gadgets"
DESCRIPTION = "Liion AB/BMS scripts to start USB gadget for USB mass storage, Ethernet, and serial interfaces"
AUTHOR = "Steven Kravatsky <skravatsky@arrow.com>"
...
SRC_URI = "file://liion-ab-bms-soc-gadget-init.service \
           file://liion-ab-bms-soc-gadget-init.sh \
           file://udhcpd.conf \
...
FILES_${PN}-network = "${base_libdir}/systemd/system/network-gadget-init.service \
                       ${bindir}/liion-ab-bms-soc-gadget-init.sh \
		       ${datadir}/${PN}"
...
SYSTEMD_PACKAGES = "${PN}"
SYSTEMD_SERVICE_${PN} = "liion-ab-bms-soc-gadget-init.service"
